...
export default function Dashboard() {
  ...
  const fetchTopTenBlogs = () => {
    axios.get(`https://localhost:7209/api/Blog/TopTenBlogs?timeType=${timeType}`)
      .then(response => {
  ...
  return (
    <>
      <Sidebar />
      <div className="container mx-auto px-4 py-8" style={{ marginLeft: "300px" }}>
      ...
      <div className="container mx-auto px-4 py-8" style={{ marginLeft: "600px",  marginTop:"-300px"}}>
